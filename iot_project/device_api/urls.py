...
from .views import DeviceDataReceive, DeviceCommandPoll, DeviceOnboardingCheck, DeviceLatestData
...
urlpatterns = [
    ...
    path('devices/<int:device_id>/latest_data/', DeviceLatestData.as_view(), name='device_latest_data'),
]